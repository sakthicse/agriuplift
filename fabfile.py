"""
Starter fabfile for deploying the agricultural project.
...
# CHANGEME
env.hosts = ['user@agricultural.example.com']
env.code_dir = '/srv/www/agricultural'
env.project_dir = '/srv/www/agricultural/agricultural'
env.static_root = '/srv/www/agricultural/static/'
env.virtualenv = '/srv/www/agricultural/.virtualenv'
env.code_repo = 'git@github.com:user/{{agricultural}}.git'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/agricultural/wsgi.py" % env.code_dir)
